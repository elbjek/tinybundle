        ...
        <div className="haven-rise max-w-xl lg:pb-6">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              id="download"
              href="#download"
              className="inline-flex items-center justify-center gap-2.5 rounded-2xl bg-haven-amber px-6 py-4 text-sm font-extrabold text-haven-on-amber shadow-[0_12px_40px_rgba(223,174,109,0.35)] transition-transform hover:bg-haven-amber-bright active:scale-[0.98]"
            >
              <AppleIcon className="h-4 w-4" />
              Download on the App Store
            </a>
            <p className="text-xs font-semibold leading-snug text-haven-soft sm:max-w-[11rem]">
  ...
  return (
    <section className="relative overflow-hidden px-5 py-20 sm:px-8 sm:py-24">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <a
          href="#download"
          className="mt-8 inline-flex items-center gap-2.5 rounded-full bg-haven-amber px-7 py-3.5 text-sm font-bold text-haven-on-amber shadow-[0_10px_32px_rgba(223,174,109,0.32)] transition-colors hover:bg-haven-amber-bright"
        >
          <AppleIcon className="h-4 w-4" />
          Download on the App Store
        </a>
